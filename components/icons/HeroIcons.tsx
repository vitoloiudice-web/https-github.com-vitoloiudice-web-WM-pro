...
// Using outline style with a consistent stroke width for a professional look.
...
export const UsersIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "h-6 w-6"}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.5-2.962c.509 0 1.02.07 1.516.205A2.986 2.986 0 0 1 12 15.75a2.986 2.986 0 0 1-2.254-1.229 6.012 6.012 0 0 0-2.254-1.229 6.012 6.012 0 0 0-2.254 1.229c-.836.836-1.372 1.942-1.372 3.129 0 1.187.536 2.293 1.372 3.129 1.63 1.63 4.257 1.63 5.887 0l1.15-1.15a3.752 3.752 0 0 0 1.15-2.653V14.25M9 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm12 0a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
    </svg>
);
...
export const WrenchScrewdriverIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "h-6 w-6"}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l2.495-2.495a1.125 1.125 0 0 1 1.591 0l3.001 3.001a1.125 1.125 0 0 1 0 1.591l-2.495 2.495M11.42 15.17 8.617 12.364a1.125 1.125 0 0 1 0-1.591l3.001-3.001a1.125 1.125 0 0 1 1.591 0l2.495 2.495m-4.896 4.896.932-.932m-.932.932-.932-.932m-6.002-6.002 2.495-2.495a1.125 1.125 0 0 1 1.591 0l3.001 3.001a1.125 1.125 0 0 1 0 1.591l-2.495 2.495M3.75 9.75l2.495-2.495a1.125 1.125 0 0 1 1.591 0l3.001 3.001a1.125 1.125 0 0 1 0 1.591l-2.495 2.495M3.75 9.75 1.255 12.245a1.125 1.125 0 0 1 0 1.591l2.495 2.495" />
    </svg>
);

export const PlusIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor" className={className || "h-5 w-5"}>
...
export const CakeIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "h-5 w-5"}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M21 15.75a.75.75 0 0 1-.75.75H3.75a.75.75 0 0 1 0-1.5h16.5a.75.75 0 0 1 .75.75Zm-18 0V12a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 12v3.75m-18 0h18M12 6.75a.75.75 0 0 0-.75-.75H10.5a.75.75 0 0 0 0 1.5h.75a.75.75 0 0 0 .75-.75Z" />
    </svg>
);
...
export const ChevronLeftIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor" className={className || "h-6 w-6"}>
...
export const BuildingOffice2Icon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "h-6 w-6"}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M21 21h-2.25m2.25-2.25H12M18.75 21V3.75A2.25 2.25 0 0 0 16.5 1.5h-9A2.25 2.25 0 0 0 5.25 3.75v17.25M9 4.5h.008v.008H9V4.5Zm.75 3h.008v.008h-.008v-.008Zm-.75 3h.008v.008H9v-.008Zm.75 3h.008v.008h-.008v-.008Zm-.75 3h.008v.008H9v-.008Zm.75 3h.008v.008h-.008v-.008Zm-.75 3h.008v.008H9v-.008Zm3-12h.008v.008h-.008V4.5Zm.75 3h.008v.008h-.008v-.008Zm-.75 3h.008v.008h-.008v-.008Zm.75 3h.008v.008h-.008v-.008Zm-.75 3h.008v.008h-.008v-.008Zm.75 3h.008v.008h-.008v-.008Z" />
    </svg>
);
